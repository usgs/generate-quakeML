...
- evaluationMode [enumeration], Must be one of the following: manual: automatic
- evaluationStatus [enumeration], Must be one of the following: reviewed, preliminary, confirmed, final, rejected, reported
